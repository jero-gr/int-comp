...
def algoritmo(num_particulas, mins, maxs, funcion_error, c1, c2, max_iteraciones, tolerancia):
    ...
    valores_error_personal = funcion_error(posiciones)
    ...
    for iteracion in range(max_iteraciones):
        ...
        valores_error_actuales = funcion_error(posiciones)  # Evaluamos las nuevas posiciones
...
mejor_solucion = algoritmo(num_particulas, mins, maxs, funcion_error, c1, c2, max_iteraciones, tolerancia)

# Evaluar el valor de la función en la mejor solución encontrada por el PSO
mejor_valor = funcion_error(mejor_solucion)
